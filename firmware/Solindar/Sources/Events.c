...
**     Date/Time   : 2019-10-02, 10:48, # CodeGen: 0
**     Abstract    :
...
** ===================================================================
*/
// Interrupcion para medir el pulso del sonar
...
/*
** ===================================================================
**     Event       :  Trigger_OnInterrupt (module Events)
**
**     Component   :  Trigger [TimerInt]
**     Description :
**         When a timer interrupt occurs this event is called (only
**         when the component is enabled - <Enable> and the events are
**         enabled - <EnableEvent>). This event is enabled only if a
